...
const CARDS: SeedSpec[] = [
  ...
  },
  {
    ...
    props: { Status: prop('select', 'In progress'), Priority: prop('select', 'Medium'), Effort: prop('decimal', '3.5'), Area: prop('select', 'Eng'), Board: prop('select', 'By Priority') },
  ...
  },
  {
    ...
    props: { Status: prop('select', 'Blocked'), Priority: prop('select', 'High'), Area: prop('select', 'Eng'), Done: prop('bool', 'no'), Board: prop('select', 'By Priority') },
    promotions: { Priority: { title: true } },
  },
  {
    body: 'Write Q3 OKRs\nDraft 3 objectives with measurable key results and circulate for feedback.',
    props: { Status: prop('select', 'Backlog'), Priority: prop('select', 'Medium'), Due: prop('date', 'Jul 1'), Area: prop('select', 'Research'), Board: prop('select', 'Product Sprint') },
    promotions: {},
  },
  {
    body: "Interview 5 power users\nRecruit from the beta cohort. Focus on workflows we don't support yet.",
    props: { Status: prop('select', 'Backlog'), Priority: prop('select', 'Low'), Area: prop('select', 'Research'), Estimate: prop('int', '5'), Board: prop('select', 'Product Sprint') },
    promotions: {},
  },
  {
    body: 'Migrate to new icon set\nReplace the 40 most-used glyphs and delete the old sprite sheet.',
    props: { Status: prop('select', 'Done'), Priority: prop('select', 'Low'), Area: prop('select', 'Design'), Done: prop('bool', 'yes'), Board: prop('select', 'Product Sprint') },
  ...
  },
  {
    ...
    props: { Status: prop('select', 'Backlog'), Priority: prop('select', 'High'), Due: prop('date', 'Aug 15'), Area: prop('select', 'Eng'), Board: prop('select', 'By Priority') },
  ...
  },
  {
    ...
    props: { Status: prop('select', 'In progress'), Priority: prop('select', 'Medium'), Effort: prop('decimal', '5.0'), Area: prop('select', 'Eng'), Board: prop('select', 'By Priority') },
    promotions: {},
  },
  {
    body: 'Thinking in Systems — Donella Meadows\nFoundational mental models for feedback loops.',
    props: { Shelf: prop('select', 'Reading'), Rating: prop('int', '5'), Link: prop('url', 'https://example.com/systems'), Board: prop('select', 'Reading List') },
  ...
  },
  {
    ...
    props: { Shelf: prop('select', 'Finished'), Rating: prop('int', '4'), Board: prop('select', 'Reading List') },
    promotions: { Rating: { title: true } },
  },
  {
    body: 'Shape Up — Basecamp\nAppetite-driven planning and the hill chart.',
    props: { Shelf: prop('select', 'To read'), Link: prop('url', 'https://basecamp.com/shapeup'), Board: prop('select', 'Reading List') },
    promotions: {},
  },
  {
    body: 'A Pattern Language — Alexander\nWhere a lot of modern design vocabulary comes from.',
    props: { Shelf: prop('select', 'Reading'), Rating: prop('int', '5'), Board: prop('select', 'Reading List') },
